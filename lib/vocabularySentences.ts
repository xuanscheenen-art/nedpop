...
const explicitLines: Record<string, string[]> = {
  ...
  arm: ["Ik beweeg mijn arm.", "Ik til mijn arm op.", "Mijn arm is sterk."],
  been: ["Ik sta op één been.", "Ik strek mijn been.", "Ik loop met mijn benen."],
  hoofd: ["Ik draai mijn hoofd.", "Ik knik met mijn hoofd.", "Houd je hoofd recht."],
  buik: ["Ik leg mijn hand op mijn buik.", "Mijn buik is vol.", "Ik adem rustig naar mijn buik."],
  hand: ["Ik schrijf met mijn hand.", "Ik was mijn handen.", "Geef me je hand."],
  voet: ["Ik zet mijn voet op de grond.", "Ik loop op blote voeten.", "Mijn voet is koud."],
  rug: ["Ik draag een tas op mijn rug.", "Ik houd mijn rug recht.", "Ik lig op mijn rug."],
  keel: ["Mijn keel is droog.", "Ik schraap mijn keel.", "Ik drink water voor mijn keel."],
