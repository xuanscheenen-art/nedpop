...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      text("42 天生活任务词包", "42 days of practical task word packs"),
  ...
  },
  {
    ...
    features: [
      ...
      text("42 天工作学习词包", "42 days of work/study word packs"),
      text("工作、mbo 学习和官方文字", "Work, mbo study, and official texts"),
      text("投诉、协商、观点表达", "Complaints, negotiation, and opinion language"),
