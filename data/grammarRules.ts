...
export const grammarRules: GrammarRule[] = [
  ...
  rule("grammar-a2-prepositions", "A2", "preposition", "介词结构：先看后面接什么", "preposition patterns: check what follows", "介词别只按中文意思死记；先判断后面是地点、方向、来源、时间、工具还是目的。", "Do not memorize prepositions by the English meaning only; first check whether the following phrase is place, direction, source, time, tool, or purpose.", "preposition + phrase type", "Ik ga naar de huisarts."),
  rule("grammar-a2-om-te", "A2", "connector", "om ... te：目的结构", "om ... te: purpose structure", "om ... te + 动词原形常用来说明目的，也可接在形容词后补充说明。", "om ... te + infinitive often gives purpose and can also complete an adjective.", "om + ... + te + infinitive", "Ik bel om een afspraak te maken."),
  rule("grammar-b1-toen", "B1", "connector", "toen 从句：过去某时", "toen clause: a past moment", "toen 用于过去的一次事件或过去一段时期；它打开从句，从句动词去后面。", "toen is used for a specific past event or past period; it opens a subordinate clause, so the verb moves to the end.", "toen + subject + rest + verb", "Toen ik thuiskwam, had ik al betaald."),
  rule("grammar-b1-als-wanneer-toen", "B1", "connector", "toen / als / wanneer", "toen / als / wanneer", "toen 指过去特定时刻；als 常用于条件或重复情况；wanneer 常用于提问或较正式的“什么时候”。", "toen refers to a specific past time; als is often condition or repeated situation; wanneer asks or states when more formally.", "past specific = toen; condition/repeated = als; question = wanneer", "Toen ik klein was, woonde ik in Utrecht."),
  rule("grammar-b1-sequence", "B1", "connector", "voordat / nadat / terwijl", "voordat / nadat / terwijl", "B1 叙事需要清楚表达先后和同时：voordat 是之前，nadat 是之后，terwijl 是同时。", "B1 storytelling needs sequence and simultaneity: voordat is before, nadat is after, terwijl is while.", "connector + subordinate clause", "Nadat ik de brief had gelezen, belde ik de gemeente."),
  rule("grammar-b1-cause-result", "B1", "connector", "doordat / daardoor", "doordat / daardoor", "doordat 接原因从句；daardoor 放主句里表示结果，后面仍按主句 V2。", "doordat introduces a cause clause; daardoor sits in a main clause for the result, so V2 still applies.", "doordat + clause; daardoor + V2", "De trein viel uit, daardoor kwam ik te laat."),
];
...
export const sentencePatterns: SentencePattern[] = [
  ...
  { id: "sentence-toen", level: "B1", title: lt("toen 从句", "toen clause"), rule: lt("toen 指过去特定时间，从句动词去后面。", "toen marks a specific past time; the subordinate-clause verb goes back."), visualBlocks: ["Toen", "ik", "thuiskwam,", "had", "ik", "al betaald"], example: { dutch: "Toen ik thuiskwam, had ik al betaald.", meaning: lt("我到家时，已经付过钱了。", "When I got home, I had already paid.") }, explanation: lt("toen 从句在前，主句 had 立刻接上。", "The toen clause comes first, then the main clause starts with had.") },
  { id: "sentence-terwijl", level: "B1", title: lt("terwijl 同时发生", "terwijl: while"), rule: lt("terwijl 打开从句，表示两个动作同时发生。", "terwijl opens a subordinate clause and shows two actions at the same time."), visualBlocks: ["Ik", "kookte", "terwijl", "mijn zoon", "sliep"], example: { dutch: "Ik kookte terwijl mijn zoon sliep.", meaning: lt("我做饭的时候，我儿子在睡觉。", "I was cooking while my son was sleeping.") }, explanation: lt("terwijl 后面的 sliep 放在从句后面。", "The verb sliep is at the end of the terwijl clause.") },
  { id: "sentence-doordat", level: "B1", title: lt("doordat / daardoor", "doordat / daardoor"), rule: lt("doordat 接原因从句；daardoor 开主句要 V2。", "doordat introduces a cause clause; daardoor starts a main clause with V2."), visualBlocks: ["Daardoor", "kwam", "ik", "te laat"], example: { dutch: "De trein viel uit, daardoor kwam ik te laat.", meaning: lt("火车取消了，因此我迟到了。", "The train was cancelled; therefore I arrived late.") }, explanation: lt("Daardoor 第一位，kwam 还是第二位。", "Daardoor takes position 1; kwam still takes position 2.") },
];
